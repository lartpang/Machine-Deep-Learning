...
简而言之，<u>SVM的损失函数想要正确分类类别![y_i](https://www.zhihu.com/equation?tex=y_i)的分数比不正确类别分数高，而且至少要高![\Delta](https://www.zhihu.com/equation?tex=%5CDelta)。如果不满足这点，就开始计算损失值。</u>
